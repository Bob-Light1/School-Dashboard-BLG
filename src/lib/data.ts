...
export const teachersData = [
  {
    id: 1,
    teacherId: "2634464890",
    name: "Mike Geller",
    email: "mike@geller.com",
    photo:
      "https://images.pexels.com/photos/428328/pexels-photo-428328.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
  ...
  },
  {
    ...
    photo:
      "https://images.pexels.com/photos/1102341/pexels-photo-1102341.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
  ...
  },
  {
    ...
    email: "jay@gmail.com",
    photo:
      "https://images.pexels.com/photos/1184464/pexels-photo-1184464.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
  ...
  },
  {
    ...
    photo:
      "https://images.pexels.com/photos/426427/pexels-photo-426427.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
    subjects: ["Physics"],
    classes: ["4A", "4B", "3C"],
    address: "Anytown, USA",
  },
  {
    ...
    photo:
      "https://images.pexels.com/photos/2838081/pexels-photo-2838081.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
  ...
  },
  {
    ...
    photo:
      "https://images.pexels.com/photos/1036623/pexels-photo-1036623.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
  ...
  },
  {
    ...
    photo:
      "https://images.pexels.com/photos/842980/pexels-photo-842980.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
  ...
  },
  {
    ...
    photo:
      "https://images.pexels.com/photos/1043444/pexels-photo-1043444.jpeg?auto=compress&cs=tinysrgb&w=2600",
    phone: "2634464890",
    subjects: ["Biology"],
    classes: ["4A", "4B", "3C"],
    address: "Anytown, USA",
...
export const studentsData = [
  {
    ...
    grade: 4,
    class: "1B",
    address: "263 Main St, Anytown, USA",
  },
  {
    id: 2,
    studentId: "2634464890",
...
export const calendarEvents = [
  {
    ...
    end: new Date(2025, 4, 26, 8, 44),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 26, 9, 0),
    end: new Date(2025, 4, 26, 9, 44),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 26, 10, 0),
    end: new Date(2025, 4, 26, 10, 44),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 26, 11, 0),
    end: new Date(2025, 4, 26, 11, 44),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 4, 26, 12, 0),
    end: new Date(2025, 4, 26, 12, 44),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 4, 26, 13, 0),
    end: new Date(2025, 4, 26, 13, 44),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 27, 8, 0),
    end: new Date(2025, 4, 27, 8, 44),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 27, 9, 0),
    end: new Date(2025, 4, 27, 9, 44),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 27, 10, 0),
    end: new Date(2025, 4, 27, 10, 44),
  },

  {
    ...
    end: new Date(2025, 4, 27, 11, 44),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 4, 28, 8, 0),
    end: new Date(2025, 4, 28, 8, 44),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 28, 9, 0),
    end: new Date(2025, 4, 28, 9, 44),
  },

  {
    ...
    end: new Date(2025, 4, 28, 10, 44),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 4, 29, 9, 0),
    end: new Date(2025, 4, 29, 9, 44),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 29, 10, 0),
    end: new Date(2025, 4, 29, 10, 44),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 29, 11, 0),
    end: new Date(2025, 4, 29, 11, 44),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 29, 12, 0),
    end: new Date(2025, 4, 29, 12, 44),
  },

  {
    ...
    end: new Date(2025, 4, 29, 13, 44),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 4, 30, 8, 0),
    end: new Date(2025, 4, 30, 8, 44),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 30, 9, 0),
    end: new Date(2025, 4, 30, 9, 44),
  },

  {
    ...
    end: new Date(2025, 4, 30, 11, 44),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 4, 30, 12, 0),
    end: new Date(2025, 4, 30, 12, 44),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 4, 30, 13, 0),
    end: new Date(2025, 4, 30, 13, 44),
  },
];