            ...
            <div className="w-full">
                ...
                <div className="flex flex-col my-3 lg:flex-row gap-4">
                     ...
                     <div className="bg-Sky py-6 px-4 rounded-md flex-1 flex gap-4 shadow-md">
                        <div className="w-1/3">
                            <Image 
                                src="https://images.pexels.com/photos/428328/pexels-photo-428328.jpeg?auto=compress&cs=tinysrgb&w=2600" 
                                alt="" 
                                width={144} 
                                height={144} 
                        ...
                        <div className="flex items-center gap-4">
                            <h1 className="text-xl font-semibold">Alfred Baldwin</h1>
                            <FormModal 
                                table="teacher" 
                                type="update"
                                data={{ 
                                    ...
                                    firstName:"Dean",
                                    lastName:"Guerrero",
                                    phone:"+237 675 85 45 25",
                                    address:"Yaounde, Cameroun",
                                    bloodType:"A+",
                                    dateOfBirth:"2000-01-01",
                                    sex:"male",
                                    img:"https://images.pexels.com/photos/428328/pexels-photo-428328.jpeg?auto=compress&cs=tinysrgb&w=2600",
                                }}/>
                        </div>
                     ...
                     <div className="flex-1 flex flex-col gap-4 justify-between  md:flex-row lg:flex-wrap">
                        ...
                        <div className="bg-gray-20 p-4 rounded-md flex gap-4 w-full md:w-[25%] lg:w-[45%] xl:w-[47%] 2xl:w-[48%] shadow-md"> 
                            <Image 
                                ...
                                <div className="">
                                    ...
                                    <span className="text-md text-gray-400">Branches</span>
                                </div>
                        </div>
                        <div className="bg-gray-20 p-4 rounded-md flex gap-4 w-full md:w-[25%] lg:w-[45%] xl:w-[47%] 2xl:w-[48%] shadow-md"> 
                            <Image 
                        ...
                        <div className="bg-gray-20 p-4 rounded-md flex gap-4 w-full md:w-[25%] lg:w-[45%] xl:w-[47%] 2xl:w-[48%] shadow-md"> 
                            <Image 
                                ...
                                <div className="">
                                    <h1 className="text-lg font-semibold">6</h1>
                                    <span className="text-md text-gray-400">Classes</span>
                                </div>
                        </div>
                     </div>
                </div>
